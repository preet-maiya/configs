...
" Move between panes with Ctrl + Shift + arrow key
...
" au FileType go let g:neomake_go_enabled_makers = ['go', 'golangci-lint']

" au FileType go call neomake#configure#automake('nrwi', 500)
" Mappings
